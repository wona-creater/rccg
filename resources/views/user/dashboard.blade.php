...
<x-app-layout>
    ...
    <div class="layout-content-container flex flex-col max-w-[960px] flex-1 md:ml-4">
        <div class="flex flex-wrap justify-between gap-3 p-4">
            <p class="text-[#0e141b] tracking-light text-[32px] font-bold leading-tight min-w-72">Hi, {{ Auth::user()->name }}</p>
        </div>
        <h3 class="text-[#0e141b] text-lg font-bold leading-tight tracking-[-0.015em] px-4 pb-2 pt-4">Dashboard</h3>
        ...
        <h3 class="text-[#0e141b] text-lg font-bold leading-tight tracking-[-0.015em] px-4 pb-2 pt-4">Performance</h3>
        <div class="flex flex-wrap gap-4 px-4 py-6">
            <div class="flex min-w-72 flex-1 flex-col gap-2 rounded-lg border border-[#d0dbe7] p-6">
                ...
                <p class="text-[#0e141b] tracking-light text-[32px] font-bold leading-tight truncate">25%</p>
                ...
                <div class="flex min-h-[180px] flex-1 flex-col gap-8 py-4">
                    ...
                    <div class="flex justify-around">
                        <p class="text-[#4e7097] text-[13px] font-bold leading-normal tracking-[0.015em]">Jul 1</p>
                        <p class="text-[#4e7097] text-[13px] font-bold leading-normal tracking-[0.015em]">Jul 8</p>
                        <p class="text-[#4e7097] text-[13px] font-bold leading-normal tracking-[0.015em]">Jul 15</p>
                        <p class="text-[#4e7097] text-[13px] font-bold leading-normal tracking-[0.015em]">Jul 22</p>
                        <p class="text-[#4e7097] text-[13px] font-bold leading-normal tracking-[0.015em]">Jul 29</p>
                    </div>
                </div>
            </div>
        </div>
